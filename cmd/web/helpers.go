...
func (app *applcation) addDefaultData(td *templateData, r *http.Request) *templateData {
	if td == nil {
		td = &templateData{}
	}
...
func (app *applcation) render(w http.ResponseWriter, r *http.Request, name string, td *templateData) {
...
func (app *applcation) isAuthenticated(r *http.Request) bool {
